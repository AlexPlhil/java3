...
public class MainFrame extends JFrame {
	...
	private GornerTableCellRenderer renderer;
	public MainFrame(Double[] coefficients) {
	super("Табулирование многочлена на отрезке по схеме Горнера");
	this.coefficients = coefficients;
	 renderer = new GornerTableCellRenderer(coefficients);
	...
	JMenu pravMenu = new JMenu("Справка");
	menuBar.add(pravMenu);
	Component frame;
	Action AboutProgramAction = new AbstractAction("О программе") {
		public void actionPerformed(ActionEvent event) {
			JLabel info=new JLabel("Выполнил Студент 9 группы, Филипчик");
JOptionPane.showMessageDialog(MainFrame.this , info, "О программе",JOptionPane.PLAIN_MESSAGE);
		}
		};
		AboutProgramItem = pravMenu.add(AboutProgramAction);
		AboutProgramItem.setEnabled(false);
	...
	AboutProgramItem.setEnabled(true);
